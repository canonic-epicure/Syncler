Class('Syncler.Composite.Array', {
    ...
    methods : {
        ...
        set : function (index, newValue) {
            ...
            replica.addMutation(new Syncler.Mutation.Array.Set({
        ...
        push  : function () {
            ...
            replica.addMutation(new Syncler.Mutation.Array.Push({
                objectID    : replica.objectToId(this),
        ...
        pop  : function () {
            ...
            replica.addMutation(new Syncler.Mutation.Array.Pop({
                objectID        : replica.objectToId(this),
        ...
        splice  : function (startAt, removeCount) {
            ...
            replica.addMutation(new Syncler.Mutation.Array.Splice({
                objectID    : replica.objectToId(this),
