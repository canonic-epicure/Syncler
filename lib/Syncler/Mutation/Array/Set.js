Class('Syncler.Mutation.Array.Set', {
    ...
    methods : {
        ...
        deRealize : function (replica) {
            ...
            object.value[ this.index ] = this.oldValue
        },
        ...
        savePrecondition : function (replica) {
            ...
            this.oldValue   = object.value[ this.index ]
        },
        ...
        checkPrecondition : function (replica) {
            ...
            return (object instanceof Syncler.Attribute.Array) && object[ this.index ] == this.oldValue
        }
    }
})
