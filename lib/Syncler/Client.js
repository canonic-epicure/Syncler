Role('Syncler.Client', {
    ...
    methods : {
        ...
        newReplica : function (args) {
            ...
            args.socketClient   = new io.Socket(this.host, { port : this.port, resource : this.resource })
    ...
    body : function () {
        ...
        WEB_SOCKET_SWF_LOCATION = 'Syncler/static/deps/socket.io/WebSocketMain.swf'
    }
})
