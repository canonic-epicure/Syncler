Class('Syncler.Channel.Server', {
    ...
    methods : {
        ...
        onIncomingUpdate : function (message) {
            console.log('INCOMING UPDATE ON SERVER: ' + JSON2.stringify(message))
        ...
        translateUpdate : function (me, message) {
            ...
            this.publish(this.getOutGoingChannelName(), message)
        },
...
//            }).now()
        ...
        onReady : function (callback) {
            // XXX implement `single` option for listeners
