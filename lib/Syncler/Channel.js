    ...
    methods : {
        ...
        commit : function () {
            ...
            if (queue.length) {
                ...
                packet = JSON2.parse(JSON2.stringify(packet))
                
                if (!packet.entries[0].$entry) debugger
                
                console.log('Commit source: ' + this.syncler.uuid)
                console.log('Commit: ' + JSON2.stringify(packet))
...
//            debugger
            ...
            console.log('Update target: ' + this.syncler.uuid)
            console.log('Update: ' + JSON2.stringify(message))
            
            this.touch()
            
//            if (!message.entries[0].$entry) debugger
