...
//        idleBuffer              : 100
    ...
    methods : {
        ...
        getInheritanceChainOf : function (classCtor) {
            ...
            for (var chain = []; classCtor.meta.superClass != Joose.Meta.Object; classCtor = classCtor.meta.superClass) chain.unshift(classCtor.meta.name)
...
//            this.on(eventName, handler, scope, options)
        ...
        addMutation : function (mutation) {
            ...
            this.fireEvent('mutation-accept', mutation)
        },
