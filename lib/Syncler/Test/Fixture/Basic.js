    ...
    continued : {
        ...
        methods : {
            ...
            populate : function (handle, t) {
                ...
                t.ok(Syncler.Object.Meta, "Syncler.Object.Meta is here")
                ...
                t.ok(replica.internalQueue.length == 3, 'History has 3 packets')
                
                var creation  = replica.internalQueue[0]
                
                t.ok(creation.object == test, 'Creation refer to correct object')
                
                var mutation0 = replica.internalQueue[1]
                var mutation1 = replica.internalQueue[2]
                ...
                t.ok(replica.internalQueue.length == 5, 'History now has 5 packets')
                
                var mutation0 = replica.internalQueue[3]
                var mutation1 = replica.internalQueue[4]
