...
//        
//        
//        collectTopicValues : function (topic) {
//            
//            var values     = {}
//            
...
//                if (name == 'replica') return
//                
//                values[ name ] = attribute.getValueFrom(topic)
//            })
//            
//            return values
//        }
...
//                        })
            ...
            verify : function (handle, t) {
                ...
                this.forEachActor(function (actor) {
                    ...
                    t.ok(this.compareTopics(t, topic, actor.topic), "Actor's [" + actor.name + "] state has been correctly converged")
                })
